...
VALUES
('LT00000001', '2025-05-10', '08:00:00', 30, N'Tự do', N'Chưa thi', 'PT0000001', 'DG00000001', 'DV00000001'),
...
('LT00000004', '2025-04-28', '14:00:00', 20, N'Đơn vị', N'Đã thi', 'PT0000004', 'DG00000004', 'DV00000004'),
...
('LT00000008', '2025-05-12', '10:00:00', 45, N'Đơn vị', N'Chưa thi', 'PT0000008', 'DG00000008', 'DV00000008'),
('LT00000009', '2025-06-01', '14:30:00', 60, N'Đơn vị', N'Chưa thi', 'PT0000009', 'DG00000009', 'DV00000009'),
...
INSERT INTO THISINH (MATHISINH, TENTHISINH, NGAYSINH, DIACHI, SĐT, EMAIL, MAPHIEUDANGKY, MALICHTHI, MAKHACHHANG)
VALUES
(10001, N'Trần Minh Sang', '1990-05-15', N'123 Đường ABC, Hà Nội', '0123456789', 'tms@example.com', 'PDK0000001', 'LT00000001', 'KH00000001'),
(10002, N'Đỗ Bảo Quỳnh', '1995-10-20', N'555 Đường MNO, Hải Phòng', '0971122334', 'dbq@example.com', 'PDK0000002', 'LT00000003', 'KH00000005'),
(10003, N'Trần Châu Thúy Vy', '2000-07-07', N'987 Đường STU, Nha Trang', '0988112233', 'thuyvy@example.com', 'PDK0000003', 'LT00000001', 'KH00000007'),
(10004, N'Nguyễn Kim Quyên', '1988-02-28', N'111 Đường YZ, Đà Lạt', '0909777888', 'kimquyen@example.com', 'PDK0000004', 'LT00000002', 'KH00000009');
GO
-- Công ty TNHH Xây dựng Thành Đạt 
INSERT INTO THISINH (MATHISINH, TENTHISINH, NGAYSINH, DIACHI, SĐT, EMAIL, MAPHIEUDANGKY, MALICHTHI, MAKHACHHANG)
VALUES
(20001, N'Nguyễn Trung Hiếu', '1997-06-21', N'456 Đường DEF, TP.HCM', '0987123456', 'nth@thanhdat.com', 'PDK0000005', 'LT00000004', 'KH00000002'),
(20002, N'Nguyễn Hoàng Nhật Huy', '1996-09-15', N'456 Đường DEF, TP.HCM', '0968112233', 'nhnh@thanhdat.com', 'PDK0000005', 'LT00000004', 'KH00000002'),
(20003, N'Huỳnh Ngọc Xuân Nhi', '1998-11-10', N'456 Đường DEF, TP.HCM', '0947123456', 'xuannhi@thanhdat.com', 'PDK0000005', 'LT00000004', 'KH00000002');
GO
-- Tập đoàn Công nghệ FutureTech 
INSERT INTO THISINH (MATHISINH, TENTHISINH, NGAYSINH, DIACHI, SĐT, EMAIL, MAPHIEUDANGKY, MALICHTHI, MAKHACHHANG)
VALUES
(20004, N'Phạm Quang Dũng', '1995-03-25', N'789 Đường GHI, Đà Nẵng', '0933112233', 'phamquangd@futuretech.com', 'PDK0000006', 'LT00000005', 'KH00000003'),
(20005, N'Võ Lê Quế Anh', '1994-07-30', N'789 Đường GHI, Đà Nẵng', '0922113344', 'anhque@futuretech.com', 'PDK0000006', 'LT00000005', 'KH00000003');
GO
-- Trung tâm Dịch vụ Y tế Hòa Bình 
INSERT INTO THISINH (MATHISINH, TENTHISINH, NGAYSINH, DIACHI, SĐT, EMAIL, MAPHIEUDANGKY, MALICHTHI, MAKHACHHANG)
VALUES
(20006, N'Vũ Văn Hộ', '1993-05-12', N'321 Đường JKL, Cần Thơ', '0911223344', 'vuvanF@hoabinhmed.com', 'PDK0000007', 'LT00000008', 'KH00000004'),
(20007, N'Trịnh Kim Chi', '1992-10-22', N'321 Đường JKL, Cần Thơ', '0902334455', 'trinhchig@hoabinhmed.com', 'PDK0000007', 'LT00000008', 'KH00000004');
GO
-- Công ty Bảo hiểm An Phát 
INSERT INTO THISINH (MATHISINH, TENTHISINH, NGAYSINH, DIACHI, SĐT, EMAIL, MAPHIEUDANGKY, MALICHTHI, MAKHACHHANG)
VALUES
(20008, N'Tô Hoàng Quân', '1991-12-05', N'654 Đường PQR, Huế', '0977445566', 'tohoangh@anphatinsurance.com', 'PDK0000008', 'LT00000009', 'KH00000006'),
(20009, N'Đặng Quỳnh Thi', '1990-04-18', N'654 Đường PQR, Huế', '0955667788', 'dangquynhi@anphatinsurance.com', 'PDK0000008', 'LT00000009', 'KH00000006'),
(20010, N'Nguyễn Hải Dương', '1989-08-27', N'654 Đường PQR, Huế', '0944556677', 'nguyenhaiduong@anphatinsurance.com', 'PDK0000008', 'LT00000009', 'KH00000006');
GO
-- Trung tâm Giải trí Galaxy
INSERT INTO THISINH (MATHISINH, TENTHISINH, NGAYSINH, DIACHI, SĐT, EMAIL, MAPHIEUDANGKY, MALICHTHI, MAKHACHHANG)
VALUES
(20011, N'Huỳnh Thị Bé Nhỏ', '1999-01-10', N'222 Đường VWX, Bình Dương', '0988776655', 'benho@galaxy.com', 'PDK0000009', 'LT00000010', 'KH00000008'),
(20012, N'Nguyễn Thị Lệ Nam Em', '2001-06-15', N'222 Đường VWX, Bình Dương', '0977665544', 'namem@galaxy.com', 'PDK0000009', 'LT00000010', 'KH00000008');
GO
-- Công ty Du lịch Bốn Mùa 
INSERT INTO THISINH (MATHISINH, TENTHISINH, NGAYSINH, DIACHI, SĐT, EMAIL, MAPHIEUDANGKY, MALICHTHI, MAKHACHHANG)
VALUES
(20013, N'Trần Thị Hương Thảo', '1995-09-23', N'888 Đường ABC, Hải Dương', '0966554433', 'thaothun@bonmuatravel.com', 'PDK0000010', 'LT00000010', 'KH00000010'),
(20014, N'Hồ Ngọc Hà', '1996-02-28', N'888 Đường ABC, Hải Dương', '0955443322', 'haho@bonmuatravel.com', 'PDK0000010', 'LT00000010', 'KH00000010');
GO
...
VALUES
('CC00000001', 'NULL', N'8.0', N'Chưa nhận', 'PDT0000001', 'KH00000001', 'NV0000001'),
('CC00000002', 'NULL', N'Không đạt', N'Chưa nhận', 'PDT0000002', 'KH00000005', 'NV0000001'),
('CC00000003', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000003', 'KH00000007', 'NV0000006'),
('CC00000004', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000004', 'KH00000009', 'NV0000006'),

('CC00000005', 'NULL', N'Không đạt', N'Chưa nhận', 'PDT0000005', 'KH00000002', 'NV0000001'),
('CC00000006', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000006', 'KH00000002', 'NV0000001'),
('CC00000007', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000007', 'KH00000002', 'NV0000006'),

('CC00000008', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000008', 'KH00000003', 'NV0000001'),
('CC00000009', 'NULL', N'Không đạt', N'Chưa nhận', 'PDT0000009', 'KH00000003', 'NV0000006'),

('CC00000010', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000010', 'KH00000004', 'NV0000001'),
('CC00000011', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000011', 'KH00000004', 'NV0000006'),

('CC00000012', 'NULL', N'Không đạt', N'Chưa nhận', 'PDT0000012', 'KH00000006', 'NV0000001'),
('CC00000013', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000013', 'KH00000006', 'NV0000001'),
('CC00000014', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000014', 'KH00000006', 'NV0000006'),

('CC00000015', 'NULL', N'Đạt', N'Chưa nhận', 'PDT0000015', 'KH00000008', 'NV0000001'),
('CC00000016', 'NULL', N'Không đạt', N'Chưa nhận', 'PDT0000016', 'KH00000008', 'NV0000006'),
