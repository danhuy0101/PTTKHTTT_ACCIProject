...
VALUES
('LT00000001', '2025-05-10', '08:00:00', 30, N'Đơn vị', N'Chưa thi', 'PT0000001', 'DG00000001', 'DV00000001'),
('LT00000002', '2025-05-15', '13:30:00', 25, N'Tự do', N'Chưa thi', 'PT0000002', 'DG00000002', 'DV00000002'),
('LT00000003', '2025-05-20', '09:00:00', 40, N'Tự do', N'Chưa thi', 'PT0000003', 'DG00000003', 'DV00000003'),
('LT00000004', '2025-04-28', '14:00:00', 20, N'Tự do', N'Đã thi', 'PT0000004', 'DG00000004', 'DV00000004'),
('LT00000005', '2025-04-30', '10:30:00', 35, N'Đơn vị', N'Đã thi', 'PT0000005', 'DG00000005', 'DV00000005'),
('LT00000006', '2025-05-05', '15:00:00', 50, N'Tự do', N'Chưa thi', 'PT0000006', 'DG00000006', 'DV00000006'),
('LT00000007', '2025-03-20', '08:30:00', 30, N'Tự do', N'Đã huỷ', 'PT0000007', 'DG00000007', 'DV00000007'),
('LT00000008', '2025-05-12', '10:00:00', 45, N'Tự do', N'Chưa thi', 'PT0000008', 'DG00000008', 'DV00000008'),
('LT00000009', '2025-06-01', '14:30:00', 60, N'Tự do', N'Chưa thi', 'PT0000009', 'DG00000009', 'DV00000009'),
('LT00000010', '2025-06-10', '09:30:00', 40, N'Đơn vị', N'Chưa thi', 'PT0000010', 'DG00000010', 'DV00000010');
...
('PDK0000002', '2025-03-28 10:15:00', 'KH0000002', 'LT00000002', 'NV0000002'),
...
VALUES
('PDT0000001', 'SBD001', N'Đã gửi', '2025-04-01', 'NV0000004', 'PDK0000001', 10001),
('PDT0000002', 'SBD002', N'Đã gửi', '2025-04-01', 'NV0000004', 'PDK0000002', 10002),
('PDT0000003', 'SBD003', N'Đã gửi', '2025-04-01', 'NV0000004', 'PDK0000003', 10003),
('PDT0000004', 'SBD004', N'Đã gửi', '2025-04-01', 'NV0000004', 'PDK0000004', 10004),

('PDT0000005', 'SBD005', N'Đã gửi', '2025-04-05', 'NV0000009', 'PDK0000005', 20001),
('PDT0000006', 'SBD006', N'Chưa gửi', '2025-04-05', 'NV0000009', 'PDK0000005', 20002),
('PDT0000007', 'SBD007', N'Đã gửi', '2025-04-05', 'NV0000009', 'PDK0000005', 20003),

('PDT0000008', 'SBD008', N'Đã gửi', '2025-04-06', 'NV0000009', 'PDK0000006', 20004),
('PDT0000009', 'SBD009', N'Chưa gửi', '2025-04-06', 'NV0000009', 'PDK0000006', 20005),

('PDT0000010', 'SBD010', N'Chưa gửi', '2025-04-07', 'NV0000009', 'PDK0000007', 20006),
('PDT0000011', 'SBD011', N'Chưa gửi', '2025-04-07', 'NV0000009', 'PDK0000007', 20007),

('PDT0000012', 'SBD012', N'Chưa gửi', '2025-04-08', 'NV0000004', 'PDK0000008', 20008),
('PDT0000013', 'SBD013', N'Đã gửi', '2025-04-08', 'NV0000004', 'PDK0000008', 20009),
('PDT0000014', 'SBD014', N'Đã gửi', '2025-04-08', 'NV0000004', 'PDK0000008', 20010),

('PDT0000015', 'SBD015', N'Đã gửi', '2025-04-09', 'NV0000009', 'PDK0000009', 20011),
('PDT0000016', 'SBD016', N'Đã gửi', '2025-04-09', 'NV0000009', 'PDK0000009', 20012),

('PDT0000017', 'SBD017', N'Đã gửi', '2025-04-10', 'NV0000009', 'PDK0000010', 20013),
('PDT0000018', 'SBD018', N'Đã gửi', '2025-04-10', 'NV0000009', 'PDK0000010', 20014);
...
GO
UPDATE GIAODICHCHUYENKHOAN
SET MAKHACHHANG = 
    CASE 
        WHEN MATHANHTOAN = 'TT0000001' THEN 'KH00000001'
        WHEN MATHANHTOAN = 'TT0000002' THEN 'KH00000002'
        WHEN MATHANHTOAN = 'TT0000003' THEN 'KH00000003'
        WHEN MATHANHTOAN = 'TT0000004' THEN 'KH00000004'
        WHEN MATHANHTOAN = 'TT0000005' THEN 'KH00000005'
        WHEN MATHANHTOAN = 'TT0000006' THEN 'KH00000006'
        WHEN MATHANHTOAN = 'TT0000007' THEN 'KH00000007'
        WHEN MATHANHTOAN = 'TT0000008' THEN 'KH00000008'
        WHEN MATHANHTOAN = 'TT0000009' THEN 'KH00000009'
        WHEN MATHANHTOAN = 'TT0000010' THEN 'KH00000010'
    END
WHERE MATHANHTOAN IN 
